...
/**
 * Test suite for my-lib v5.0.0 migration schematic
 * 
...
describe('Update to v5.0.0', () => {
  ...
  it('should run successfully', async () => {
    const tree = await runner.runSchematic('update-5-0-0', {}, appTree);
  ...
  //   
  //   const tree = await runner.runSchematic('update-5-0-0', {}, inputTree);
