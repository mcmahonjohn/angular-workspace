...
/**
 * Migration schematic for my-lib v3.0.0
 * 
 * TODO: Implement migration logic for v3.0.0 breaking changes
 * 
 ...
 */
export function updateToV3(): (_tree: Tree, context: SchematicContext) => Tree {
  return (tree: Tree, context: SchematicContext) => {
    context.logger.info('🚀 Running my-lib migration to v3.0.0...');
    ...
    context.logger.info('✅ Migration to v3.0.0 completed successfully!');
