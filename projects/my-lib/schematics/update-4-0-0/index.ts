...
/**
 * Migration schematic for my-lib v4.0.0
 * 
 * TODO: Implement migration logic for v4.0.0 breaking changes
 * 
 ...
 */
export function updateToV4(): (_tree: Tree, context: SchematicContext) => Tree {
  return (tree: Tree, context: SchematicContext) => {
    context.logger.info('🚀 Running my-lib migration to v4.0.0...');
    ...
    context.logger.info('✅ Migration to v4.0.0 completed successfully!');
