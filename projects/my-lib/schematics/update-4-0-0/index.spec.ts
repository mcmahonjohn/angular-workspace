...
/**
 * Test suite for my-lib v4.0.0 migration schematic
 * 
...
describe('Update to v4.0.0', () => {
  ...
  it('should run successfully', async () => {
    const tree = await runner.runSchematicAsync('update-4-0-0', {}, Tree.empty()).toPromise();
  ...
  //   
  //   const tree = await runner.runSchematicAsync('update-4-0-0', {}, inputTree).toPromise();
